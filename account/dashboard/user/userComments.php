...
<h1 class="text-3xl py-10 font-medium justify-center text-center bg-black text-white capitalize lg:text-3xl dark:text-white">My Activity</h1>  
    ...
    <button onclick="window.location.href='../user/';" class="float-right m-6 mt-0 shadow-md bg-white shadow-slate-700 p-10 rounded-lg px-6 py-5 border border-black text-black duration-100 hover:bg-yellow-200 hover:shadow-none text-medium focus:bg-yellow-100" type="button">Back to Dashboard</button>
        ...
        <div class="justify-center text-center ">
            <?php if($comments->num_rows > 0): ?>
                ...
                <?php endwhile ?>            
            <?php else: ?>
                <p class="mb-4 text-sm text-gray-700">There are no published comments from you yet</p>
            <?php endif ?>           
        </div>
