...
<body>
    <section class="min-h-screen flex items-stretch text-white ">
        <div class="lg:w-full w-full flex items-center justify-center text-center md:px-16 px-0 z-0 bg-cover items-center" style="background-image: url(../../assets/images/audience.jpg);">
            <div class="w-full py-6 z-20 bg-cover relative items-center">
                ...
                <form action="../../account/auth/authenticate.php" method="post" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                    ...
                    <div>
                        <button class="login-button bg-black" value="LOGIN" type="submit">sign in</button>
                    </div>
                    <div class="lg:flex w-full bg-gray-500 bg-no-repeat bg-cover relative items-center" style="background-image: url(../../assets/images/audience.jpg);">
                    </div>
